...
import com.gcit.todo_20_i.SecondActivity;

public class MainActivity extends AppCompatActivity {
        // Class name for Log tag
        private static final String LOG_TAG = com.gcit.todo_20_i.MainActivity.class.getSimpleName();
    ...
    public void launchSecondActivity(View view) {
        ...
        Intent intent = new Intent(this, com.gcit.todo_20_i.SecondActivity.class);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == TEXT_REQUEST) {
            ...
            if (resultCode == RESULT_OK) {
                String reply = data.getStringExtra(com.gcit.todo_20_i.SecondActivity.EXTRA_REPLY);
